...
class ComboBox(QComboBox):
    ...
    def __init__(self, items=None, parent=None):
        ...
        self.lineEdit().setPlaceholderText(get_text("nav_labels.combo_box_texts.placeholder"))
    ...
    def _update_display(self):
        ...
        if len(checked) == 0:
            self.lineEdit().setText(get_text("nav_labels.combo_box_texts.none"))
        elif len(checked) == total:
            self.lineEdit().setText(get_text("nav_labels.combo_box_texts.all"))
        else:
