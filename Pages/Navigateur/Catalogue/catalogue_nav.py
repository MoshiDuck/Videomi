...
class Catalogue(QWidget):
    def __init__(self, switch_to_lecteur, db_manager: DatabaseManager, client_1fichier: FichierClient,
        ...
        self.item_widgets = []
        self.label_videos = get_text("nav_labels.catalogue_texts.videos")
        self.label_musics = get_text("nav_labels.catalogue_texts.musics")
        self.current_category = self.label_videos
        self.view_mode = 'grid'
    ...
    def toggle_category(self, category_label: str):
        ...
        is_media = category_label in (self.label_videos, self.label_musics)
