...
class VideoCache:
    """
    Gère la lecture et l'écriture du cache video_info sur disque au format JSON.
    """
    ...
    def _load_cache(self) -> dict[str, dict[str, Any]]:
        ...
        try:
            ...
            logging.error(f"Erreur lors du chargement du cache vidéo : {e}")
            return {}
    ...
    def save(self) -> None:
        try:
            ...
            logging.error(f"Erreur lors de l'enregistrement du cache vidéo : {e}")
