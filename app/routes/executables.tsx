...
export default function ExecutablesRoute() {
    ...
    const handleFileDeleted = useCallback((fileId: string) => {
        setExecutables((prev) => prev.filter((exec) => exec.file_id !== fileId));
    }, []);
    ...
    useRefetchOnCacheInvalidation(user?.id ?? null, 'executables', fetchFiles);
                        ...
                        <div style={{
                            ...
                            {executables.map((executable) => (
                                <DraggableItem
                                    ...
                                    item={{
                                        file_id: executable.file_id,
                                        category: executable.category,
                                        filename: executable.filename,
                                        size: executable.size,
                                        mime_type: executable.mime_type,
                                    }}
                                >
                                    <div
