// INFO : app/routes/archives.tsx — contenu uniquement ; layout _app fournit Navigation + AuthGuard.
...
export default function ArchivesRoute() {
    ...
    useRefetchOnCacheInvalidation(user?.id ?? null, 'archives', fetchFiles);
